    ...
    outlier.test.results <- future.apply::future_lapply(
        ...
        FUN = function(i) {
            ...
            calculate.p.values2(
                x = x,
                x.distribution = optimal.distribution.data[i],
                x.zrange.mean = data.zrange.mean[1],
                x.zrange.median = data.zrange.median[1],
                x.zrange.trimmean = data.zrange.trimmean[1],
                x.fraction.kmeans = data.fraction.kmeans[1],
                x.cosine.similarity = data.cosine.similarity[1],
                null.data = null.data,
                null.distributions = optimal.distribution.null.data,
